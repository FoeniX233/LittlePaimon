...
help_ = on_command('help', aliases={'帮助菜单', '打工战士帮助'}, priority=1, block=True)
help_.__paimon_help__ = {
    "usage":     "帮助菜单|help",
    "introduce": "查看打工战士的帮助信息",
    "priority":  99
}
...
def draw_help_info(help_info: dict):
    ...
    draw_shadow_text(draw, (50, 50), '打工战士帮助', get_font(140), (255, 255, 255), (0, 0, 0, 255), (3, 3))
